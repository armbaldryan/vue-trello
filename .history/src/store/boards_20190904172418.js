...
export default {
  ...
  actions: {
    ...
    async editLists({ commit }, { userId, boardId, payload }) {
      ...
      const newLists = [
        {
          id: "-LnvyHc0nS7Tfm0GOMGC",
          items: [
            { cardId: "-Lnw1mXqc5Wwq7rqYkel", id: 1567596685588, title: "asd" },
          ],
          title: "test1",
        },
        {
          id: "-LnwLGL_wi0FFajA8-sG",
          items: [
            {
              cardId: "-LnvyIY1gxeoKo5AFhI1",
              id: 1567595510077,
              title: "daasad",
            },
            { cardId: "-Lnw1mXqc5Wwq7rqYkel", id: 1567596685588, title: "asd" },
            { cardId: "-LnwLHJsuAIY9RqIYHy7", id: 1567601796495, title: "i" },
          ],
